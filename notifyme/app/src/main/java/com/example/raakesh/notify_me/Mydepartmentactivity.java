 ...
 */
public class Mydepartmentactivity extends ActionBarActivity implements AdapterView.OnItemClickListener{
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> postList, ParseException e) {
                ...
                if (e == null) {
                    ...
                    listview=(ListView)findViewById(R.id.list);
                    adapter=new NotificationAdapter(Mydepartmentactivity.this,posts,R.drawable.dept);
                    listview.setAdapter(adapter);
                } else {
