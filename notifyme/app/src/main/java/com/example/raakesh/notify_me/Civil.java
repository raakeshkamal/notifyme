 ...
 */
public class Civil extends ActionBarActivity implements AdapterView.OnItemClickListener{
    private ArrayList<Notification> posts;
    private String department="Civil";
    ListView listview;
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> postList, ParseException e) {
                ...
                if (e == null) {
                    ...
                    listview=(ListView)findViewById(R.id.list);
                    adapter=new NotificationAdapter(Civil.this,posts,R.drawable.dept);
                    listview.setAdapter(adapter);
                } else {
