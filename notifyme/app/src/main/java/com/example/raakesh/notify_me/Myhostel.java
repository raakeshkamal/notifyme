 ...
 */
public class Myhostel extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setBackgroundResource(R.drawable.back6);
        ...
        posts = new ArrayList<>();
        //posts.add(new Notification("1234","me","nothing","nothing","hostel"));
        adapter=new NotificationAdapter(this,posts,R.drawable.hostel);
    ...
    private void refreshPostList() {
        ...
        query.whereEqualTo("type", ParseUser.getCurrentUser().getString("hostel"));
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> postList, ParseException e) {
                ...
                if (e == null) {
                   ...
                   Log.i("damn it",Integer.toString(postList.size()));
                    listview=(ListView)findViewById(R.id.list);
                 adapter=new NotificationAdapter(getApplicationContext(),posts,R.drawable.hostel);
                    listview.setAdapter(adapter);
                } else {
