 ...
 */
public class Mech extends ActionBarActivity implements AdapterView.OnItemClickListener{
    private ArrayList<Notification> posts;
    private String department="Mech";
    ListView listview;
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> postList, ParseException e) {
                ...
                if (e == null) {
                    ...
                    listview=(ListView)findViewById(R.id.list);
                    adapter=new NotificationAdapter(Mech.this,posts,R.drawable.dept);
                    listview.setAdapter(adapter);
                } else {
