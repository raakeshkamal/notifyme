 ...
 */
public class Buyandsell extends ActionBarActivity implements AdapterView.OnItemClickListener{
   ...
   // public static ArrayAdapter<Notification> adapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setBackgroundResource(R.drawable.back7);
       ...
       // ArrayAdapter<Notification> adapter = new ArrayAdapter<Notification>(this,R.layout.list_item_layout, posts);
        adapter=new NotificationAdapter(this,posts,R.drawable.buy);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_new: {
                ...
                intent.putExtra("type","buyandsell");
    ...
    private void refreshPostList() {
        ...
        query.whereEqualTo("type", "buyandsell");
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> postList, ParseException e) {
                ...
                if (e == null) {
                    ...
                    listview=(ListView)findViewById(R.id.list);
                    adapter=new NotificationAdapter(Buyandsell.this,posts,R.drawable.buy);
                    listview.setAdapter(adapter);
                } else {
