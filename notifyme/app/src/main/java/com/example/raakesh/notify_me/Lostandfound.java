 ...
 */
public class Lostandfound extends ActionBarActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        posts = new ArrayList<>();
        adapter=new NotificationAdapter(this,posts,R.drawable.images);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_new: {
                ...
                intent.putExtra("type","lostandfound");
                startActivity(intent);
                break;
            }
    ...
    private void refreshPostList() {
        ...
        query.whereEqualTo("type", "lostandfound");
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> postList, ParseException e) {
                ...
                if (e == null) {
                    ...
                    listview=(ListView)findViewById(R.id.list);
                    int i=R.drawable.images;
                 adapter=new NotificationAdapter(Lostandfound.this,posts,i);
                 listview.setAdapter(adapter);
                } else {
